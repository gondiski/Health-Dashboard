...
class Terms extends Component {
    render() {
        return ( <
            ...
            ol type = "a" >
            <
            li > Permission is granted to temporarily download one copy of the materials(information or software) on healthyapi 's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not: <
            ol type = "i" >
            <
            li > modify or copy the materials; < /li> <
            li > use the materials
            ...
            for any damages(including, without limitation, damages
                for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on healthyapi 's website, even if healthyapi or a healthyapi authorized representative has been notified orally or in writing of the possibility of such damage. Because some jurisdictions do not allow limitations on implied warranties, or limitations of liability for consequential or incidental damages, these limitations may not apply to you.</p> <
            h3 > 5. Accuracy of materials < /h3> <
            p > The materials appearing on healthyapi 's website could include technical, typographical, or photographic errors. healthyapi does not warrant that any of the materials on its website are accurate, complete or current. healthyapi may make changes to the materials contained on its website at any time without notice. However healthyapi does not make any commitment to update the materials.</p> <
            h3 > 6. Links < /h3> <
            p > healthyapi has not reviewed all of the sites linked to its website and is not responsible
            for the contents of any such linked site.The inclusion of any link does not imply endorsement by healthyapi of the site.Use of any such linked website is at the user 's own risk.</p> <
